    ...
    <td>
        <div class="img">
            <a href="/ProductDetail/Index/${product.productId}"><img src="${product.productCoverImage}" alt="${product.productName}"></a>
            <a href="/ProductDetail/Index/${product.productId}"><p>${product.productName} (Size: ${product.size})</p></a>
        </div>
    </td>
